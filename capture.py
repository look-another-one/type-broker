...
from google_captcha import captcha_sender
import pyautogui
...
def shot_captcha():
    # taking a screenshot of whole screen : 
    captcha_screenshot = pyautogui.screenshot()
    # saving as cap.png
    captcha_screenshot.save("cap.png")
    # outputing success : 
    print("Saved Captcha Screenshot Waiting for response ...")
    # Redirecting :
    captcha_sender()
